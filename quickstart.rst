...
installer <http://karchinlab.org/opencravat/installers/open-cravat-2.2.1.exe>`__
...
**Mac OS users**: `Mac OS
installer <http://karchinlab.org/opencravat/installers/OpenCRAVAT.2.2.1.pkg>`__
